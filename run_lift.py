...
from lift_dataset import LIFT_DATASET
...
if __name__ == "__main__":
    ...
    for folder_name in folder_names:
        ...
        try:
            ...
            continue
        dataset = LIFT_DATASET(
            dataset_path, sequence_name, reference_mesh_path="bundlesdf/output_lift"
        )
